        ...
        <div>
            <div className='h-screen relative flex flex-col items-center justify-center'>
                ...
                <motion.img
                    src={astronaut3}
                    alt=""
                    className='object-cover h-[55%] md:h-[90%] md:mt-auto relative z-10'
                    animate={{ y: [0, -7, 0] }}
                    transition={{
                        duration: 2,
                        repeat: Infinity,
            ...
            <div className='about h-[50vh] flex flex-col md:flex-row'>
                <div className="box w-[100%] md:w-[40%] relative text-white flex items-center justify-center">
                    <motion.div className='absolute z-0 md:bottom-20 md:right-15 h-full md:h-[40%] w-[70%] bg-black border-r-1 border-b-1 rounded-xl border-white'
                        animate={{ y: [0, -3, 0] }}
                        transition={{
                            duration: 2.5,
                            repeat: Infinity,
